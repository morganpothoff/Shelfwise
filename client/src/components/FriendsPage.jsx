              ...
              {filteredFriends.map(friend => (
                <div key={friend.friend_id} className="flex items-center justify-between p-4 rounded-lg border border-theme">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0 ml-3">
                    <Link
                      to={`/friends/${friend.friend_id}/library`}
                      className="text-theme-accent hover:text-theme-accent-hover text-sm font-medium px-3 py-1 rounded-lg hover:bg-theme-secondary transition"
                    >
                      View Library
                    </Link>
                    <button
