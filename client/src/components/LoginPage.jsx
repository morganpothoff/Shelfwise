    ...
    <div className="min-h-screen bg-theme-gradient flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-theme-card rounded-2xl shadow-xl p-8">
          <h2 className="text-2xl font-semibold text-theme-primary mb-6">Welcome Back</h2>
          ...
          <div className="mt-6 text-center">
            <p className="text-theme-muted">
              ...
              <Link to="/register" className="text-theme-secondary hover:underline font-medium">
                Create one
              </Link>
            </p>
          </div>
